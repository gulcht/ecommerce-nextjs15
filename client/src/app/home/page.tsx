          ...
          >
            ...
            <div className="relative h-full container mx-auto px-4 flex items-center">
              <div className="text-white space-y-6">
                ...
                <p className="text-lg">
                  A Creatie, Flexible, Clean, Easy to use and
                  <br></br>
                  High Performance Ecommerce theme
                </p>
                <Button className="bg-white text-black hover:bg-gray-100 px-8 py-6 text-lg hover:cursor-pointer">
                  SHOP NOW
                </Button>
              </div>
            </div>
              ...
              <div key={index} className="relative group overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-25 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="text-center text-white p-4">
                    ...
                    <Button className="mt-4 bg-white text-black hover:bg-gray-100 hover:cursor-pointer">
                      SHOP NOW
                    </Button>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {featuredProducts.map((productItem, index) => (
              <div key={index} className="relative group overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-100 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="text-center text-white p-4">
                    <h3 className="text-xl font-semibold mb-2">
                      {productItem.name}
                    </h3>
